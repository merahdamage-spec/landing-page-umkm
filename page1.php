...
<!-- Scripts -->
  ...
  // Pesan konfirmasi
  document.getElementById("contactForm").addEventListener("submit", function(e) {
    alert("Terima kasih! Pesanan Anda telah dikirim ke Kinara Laundry 💙");
  });
